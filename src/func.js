    ...
    commandExecution(command) {
        ...
        switch (command) {
            case "-help":
                ...
                break;
            case "contact":
                result += "<br/>E-mail: <a href='mailto:alireza_mortezaei@hotmail.com'>alireza_mortezaei@hotmail.com</a><br/>Phone number: +989360019915<br/>Instagram: <a href='instagram.com/91alim'>@91alim</a><br/>Linkedin profile: <a href='https://www.linkedin.com/in/alireza-mortezaei-55280a143/'>https://www.linkedin.com/in/alireza-mortezaei-55280a143/</a><br/>"
                break;
            case "about":
                ...
                break;
            case "skills":
                result += "<ul><li>Object-oriented programming</li><li>MVC</li><li>php</li><li>Javascript</li><li>css</li><li>HTML5</li><li>Laravel</li><li>vue.js</li><li>Agile development</li></ul>"
                break;
            case "resume":
